...
import (
	"behu/application/follow/rpc/internal/code"
	"behu/application/follow/rpc/internal/model"
	"behu/application/follow/rpc/internal/types"
	"context"
	"github.com/zeromicro/go-zero/core/threading"
	"strconv"
	"time"

	"behu/application/follow/rpc/internal/svc"
	"behu/application/follow/rpc/pb"
...
func (l *FollowListLogic) FollowList(in *pb.FollowListRequest) (*pb.FollowListResponse, error) {
	...
	l.Logger.Infof("[curPage] curPage: %v", curPage)
